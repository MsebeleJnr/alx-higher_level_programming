...
OBOBOBOBOBOB* Overwrite of `__str__` method to print a `Square` instance in the format `[Square] (<id>) <x>/<y>`.
* Public method `def update(self, *args, **kwargs):` that updates an instance of a `Square` with the given attributes.
OBOBOB  * `*args` must be supplied in the following order:
OBOBOBOBOBOB    * 1st: `id`
    * 2nd: `size`
    * 3rd: `x`
    * 4th: `y`
